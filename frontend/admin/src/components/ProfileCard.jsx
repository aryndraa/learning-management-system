    ...
    <>
      <div className="flex justify-between items-center p-4 bg-white rounded-lg relative">
        ...
        <div className="flex items-center gap-2">
          <button className="text-2xl p-2 border-font-100 border rounded-full text-font-100 ">
            <IoMdMore />
          </button>
          <div className="bg-white flex flex-col absolute right-0 left-0 transform translate-y-32 shadow-md rounded-lg">
