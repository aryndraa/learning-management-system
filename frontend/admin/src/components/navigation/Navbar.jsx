...
const Navbar = ({sideClose = false, children}) => {
  ...
  return (
    <>
      <div className={`group bg-white flex lg:flex-col justify-between lg:justify-normal items-center lg:items-center px-3  py-5 md:py-6 relative lg:fixed top-0 left-0 bottom-0 z-50 lg:m-4 lg:rounded-lg lg:shadow  ${
